  ...
  return (
    <div className="p-5 bg-gray-600 text-white">
      ...
      <form
        ...
        className="md:w-1/2 md:mx-auto md:bg-gray-500 md:p-5 rounded"
      >
        <p className="my-7 text-sm md:text-lg md:my-5">
          Kindly fill in the form to join the waitlist.
        </p>
        ...
        <button
          type="submit"
          className={`bg-blue-400 p-2 border-none rounded ${loading ? "opacity-50 cursor-not-allowed" : ""}`}
          disabled={loading}
        >
