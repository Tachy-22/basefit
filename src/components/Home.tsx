  ...
  return (
    <div className="h-full">
      ...
      <motion.section
        ...
        className="flex flex-col items-center justify-center py-20 bg-gradient-to-r  h-[80vh]"
      >
        ...
        <button className=" px-6 py-3 rounded-full font-semibold hover:bg-cyan-100 z-20">
          Get Started
        </button>
      </motion.section>
      ...
      <section className=" py-20 text-center w-full">
        ...
        <div className="flex justify-center space-x-6">
          <button className=" px-6 py-3 rounded-full font-semibold hover:bg-coral-100">
            Join Now
          </button>
          <button className=" px-6 py-3 rounded-full font-semibold hover:bg-coral-100">
            Learn More
      ...
      {/* Features Section */}
      <section className="  mx-auto py-12 px-6 w-full">
